...
between '2015/07/01' and '2016/05/10'";
...
#myInput {
  ...
  margin-bottom: 12px;
		...
		<section id="content">
			<div class="container">
			<center><h1>Student Placed in 2015-2016</h1>
	<a href="placed_student.php"  align="left" class="btn btn-primary waves-effect waves-dark">BACK</a>
	
				<input type="text" class="light-table-filter" data-table="order-table" id="myInput" onkeyup="myFunction()"  placeholder="&nbsp &nbsp &nbsp &nbsp Search student placed in 2015" title="SEARCH"></center>				
			<?php

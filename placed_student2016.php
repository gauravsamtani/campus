...
// $sql = "SELECT * FROM report";
 $sql = "SELECT * FROM report where visiting_date 
between '2016/07/01' and '2017/05/10'";
 // where visiting_date between 2016/09/29 and 2017/04/10;
...
#myInput {
  background-image: url('img/searc.png');
  ...
  margin-bottom: 12px;
		...
		<section id="content">
			<div class="container">
			<center><h1>Student Placed in 2016-2017</h1>
	<a href="placed_student.php"  align="left" class="btn btn-primary waves-effect waves-dark">BACK</a>
	
				<input type="text" class="light-table-filter" data-table="order-table" id="myInput" onkeyup="myFunction()"  placeholder="&nbsp &nbsp &nbsp &nbsp Search student placed in 2016" title="SEARCH"></center>				
			<?php
...
<table class="order-table table table-hover table-striped" id="myTable" style="width:80%" align="center">
<thead>
<tr>
<!-- <td><h3>#&emsp;&emsp;</h3></td> -->
<!-- <td><h3><b>Visiting Date &emsp;</h3></td> -->
<td><h3><b>Tier </h3></td>
<td><h3><b>Student Name </h3></td>
<td><h3><b>Company </h3></td>

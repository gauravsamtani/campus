...
<div id="wrapper" class="home-page"> 
            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li class="active"><a class="waves-effect waves-dark" href="com_home.php">Home</a></li> 
                        ...
                        <!-- <li class="dropdown">
                        <a href="#" data-toggle="dropdown" class="dropdown-toggle waves-effect waves-dark glyphicon-user">PROFILE <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li><a class="waves-effect waves-dark" href="company_profile.php"><b>View</b></a></li>
	...
	<!-- Slider -->
        <div id="main-slider" class="flexslider">
            <ul class="slides">
              <li>
                <img src="img/slides/cm1.jpg" alt="" />
              ...
              <li>
                <img src="img/slides/cm2.jpg" alt="" />
                <div class="flex-caption">
              ...
              <li>
                <img src="img/slides/cm3.jpg" alt="" />
                <div class="flex-caption">

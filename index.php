            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
						...
						<!--<li><a class="waves-effect waves-dark" href="information.php">Services</a></li>-->
                        <!-- <li><a class="waves-effect waves-dark" href="#placement">Placement</a></li>  -->
                        <li><a class="waves-effect waves-dark" href="information.php">Information</a></li>
                        <li class="dropdown">
                        <a href="#" data-toggle="dropdown" class="dropdown-toggle waves-effect waves-dark">Login <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li><a class="waves-effect waves-dark" href="comlogin.php">Company</a></li>
                            <li><a class="waves-effect waves-dark" href="studlogin.php">Student</a></li>
...
<!-- 
	...
	<section>
		<center><h1>Companies Visiting Campus</h1></center>
...
<table class="order-table table table-striped" style="width:80%" align="center">
<tr>
<!-- <td><h3>#&emsp;&emsp;</h3></td> -->
<td><h3>Company &emsp;&emsp;</h3></td>
...
<!-- <td>&emsp;&emsp;<a href="studentacc.php?id=<?php echo $row['com_id']?>"><img src="img/registergreen.png" width="100px" height="50px" title="Register"></a></td> -->
</tr>
...
Sonata Software (T-3) is expected to visit campus on 9th Feb'17 to conduct an online test. 
 ...
 through the link provided below not later than tomorrow by 10.30AM.</p></div>
	...
	<div>
<a href="#" class="scrollup waves-effect waves-dark"><i class="fa fa-angle-up active"></i></a></div>	
<!-- javascript
    ================================================== -->
...
<script src="js/agency.min.js"></script>Q
</body>
</html>
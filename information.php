                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <!--<li><a class="waves-effect waves-dark" href="services.php">Services</a></li>
                         <li><a class="waves-effect waves-dark" href="portfolio.php">Portfolio</a></li> -->
                        	<li class="active"><a class="waves-effect waves-dark" href="information.php">Information</a></li>
                        	<li class="dropdown">
		...
		<div class="row">
			...
			<div class="col-lg-4">
				<div class="pricing-box-item">
					...
					<div class="pricing-action">
						<a href="total_compnies.php" class="btn btn-medium"><i class="icon-bolt"></i> Know More</a>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4">
				<div class="pricing-box-item activeItem">
					...
					<div class="pricing-action">
						<a href="placed_student.php" class="btn btn-medium"><i class="icon-bolt"></i>Know More</a>
					</div>
				</div>
			</div>
			<div class="col-lg-4">
				<div class="pricing-box-item">
					...
					<div class="pricing-action">
						<a href="intern_student.php" class="btn btn-medium"><i class="icon-bolt"></i> Know More</a>
					</div>
				</div>
			</div>
		</div>

...
$sql = "SELECT * FROM total_companies";
...
#myInput {
  ...
  margin-bottom: 12px;
		...
		<section id="content">
			<div class="container">
			<center><h1>Companies visited in  2016-2017</h1>
	<!-- <a href="information.php"  align="left" class="btn btn-primary waves-effect waves-dark">BACK</a> -->
	
				<input type="text" class="light-table-filter" data-table="order-table" id="myInput" onkeyup="myFunction()"  placeholder="&nbsp &nbsp &nbsp &nbsp Search student placed tier wise" title="TYPE TIER WISE"></center>				
			<?php
...
<td><h3><b>&emsp; Tier &emsp;</h3></td>
<!-- <td><h3><b>Visiting Date &emsp;</h3></td> --> 
<th><h3><b>Company Name </h3></th>
<th><h3><b>CTC / Stipend </h3></th>
...
<tr>
<!-- <td><?php echo $i;?></td> -->
<td><b><?php echo $row["tier_com"];?></td>
<!-- <td><b><?php echo $row["visitings_date"];?></td> -->

...
#myInput {
  ...
  margin-bottom: 12px;
	...
	<!-- <div class="table-responsive"> -->
				<input type="text" class="light-table-filter" data-table="order-table" id="myInput" onkeyup="myFunction()"  placeholder="&nbsp &nbsp &nbsp &nbsp Search Compnies" title="SEARCH"></center>				
			<?php
...
<!-- <td><h3><b>Visiting Date &emsp;</h3></td> --> 
<td><h3><b>Company Name </h3></td>
<td><h3><b>CTC / Stipend </h3></td>

...
$sql = "SELECT * FROM job_details where status=0";
...
<section id="inner-headline">
	...
	<section>
        ...
        <center><h1>All Company Details</h1></center>
            <center><a href="admin_comdetails.php"  class="btn btn-primary waves-effect waves-dark">check</a></center>
        </div>
    </section>
